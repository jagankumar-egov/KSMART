...
public class BankAccountEntity extends AuditableEntity {
	...
	public BankAccount toDomain() {
		...
		bankAccount.setModuleId(this.bussinessservice);
		bankAccount.setServiceId(this.serviceid);
		return bankAccount;
	}
	...
	public BankAccountEntity toEntity(BankAccount bankAccount) {
		...
		this.bussinessservice= bankAccount.getModuleId();
		this.serviceid= bankAccount.getServiceId();
		return this;
	}
