package org.ksmart.birth.marriageregistry.repository.querybuilder;


import org.ksmart.birth.marriageregistry.model.RegisterBirthSearchCriteria;
...
public class RegisterQueryBuilder extends BaseRegBuilder {
    private static final String QUERY=new StringBuilder().append("SELECT krbd.id,	krbd.dateofreport,	krbd.dateofbirth,	krbd.timeofbirth,	krbd.am_pm,	krbd.firstname_en,	krbd.firstname_ml,	krbd.middlename_en,")
            ...
            .append("kperad.villageid as per_villageid,kperad.tenantid as per_tenantid,kperad.talukid as per_talukid,kperad.districtid as per_districtid,")
            ...
            .append("kperad.bio_adopt as per_bio_adopt,kperad.res_asso_no_ml as per_res_asso_no_ml,kpreadd.id as pres_id,")
            ...
            .append("kpreadd.ot_address2_ml as pres_ot_address2_ml,")
