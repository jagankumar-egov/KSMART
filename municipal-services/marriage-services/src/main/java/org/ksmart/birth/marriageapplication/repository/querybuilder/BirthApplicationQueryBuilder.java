...
public class BirthApplicationQueryBuilder extends BaseBirthQuery {
    private static final String QUERY = new StringBuilder().append("SELECt ebd.id as ba_id,ebd.dateofreport as ba_dateofreport,ebd.dateofbirth as ba_dateofbirth,ebd.timeofbirth as ba_timeofbirth,ebd.am_pm as ba_am_pm,ebd.firstname_en as ba_firstname_en,")
            ...
            .append("ebmi.birthdtlid as mo_birthdtlid,ebmi.bio_adopt as mo_bio_adopt,eperad.id as per_id,eperad.resdnce_addr_type as per_resdnce_addr_type,eperad.buildingno as per_buildingno,")
            .append("eperad.houseno as per_houseno,eperad.res_asso_no as per_res_asso_no,eperad.housename_en as per_housename_en,eperad.housename_ml as per_housename_ml,eperad.ot_address1_en as per_ot_address1_en,")
            ...
            .append("eperad.lastmodifiedby ,eperad.lastmodifiedtime,eperad.birthdtlid as per_birthdtlid,eperad.same_as_present as per_same_as_present,")
            .append("eperad.bio_adopt as per_bio_adopt,eperad.res_asso_no_ml as per_res_asso_no_ml,")
            ...
            .append("ebp.ho_villageid as pla_ho_villageid,ebp.ho_talukid as pla_ho_talukid,ebp.ho_districtid as pla_ho_districtid,")
            ...
            .append("epreadd.houseno as pres_houseno,epreadd.res_asso_no as pres_res_asso_no,epreadd.housename_en as pres_housename_en,epreadd.housename_ml as pres_housename_ml,epreadd.ot_address1_en as pres_ot_address1_en,")
            ...
            .append("epreadd.lastmodifiedby,epreadd.lastmodifiedtime ,epreadd.birthdtlid as pres_birthdtlid,epreadd.bio_adopt as pres_bio_adopt,")
            .append("epreadd.res_asso_no_ml as pres_res_asso_no_ml,estat.id as stat_id,estat.weight_of_child as stat_weight_of_child,")
            ...
            .append("estat.mother_order_cur_child as stat_mother_order_cur_child,estat.mother_res_no_of_years as stat_mother_res_no_of_years,estat.mother_dob as stat_mother_dob")
