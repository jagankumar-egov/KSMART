-- Table: public.kl_birth_details

-- DROP TABLE IF EXISTS public.kl_birth_details;
CREATE TABLE public.kl_birth_details
(
    ...
    CONSTRAINT kl_birth_details_pkey PRIMARY KEY (id),
    CONSTRAINT kl_birth_details_applicationno_key UNIQUE (applicationno),
    CONSTRAINT kl_birth_details_fm_fileno_ukey UNIQUE (fm_fileno, tenantid),
    CONSTRAINT kl_birth_details_registrationno_ukey1 UNIQUE (registrationno, tenantid)
);

-- Index: idx_kl_birth_details_tenantid

-- DROP INDEX IF EXISTS public.idx_kl_birth_details_tenantid;

CREATE INDEX IF NOT EXISTS idx_kl_birth_details_tenantid
    ON public.kl_birth_details USING btree
    (tenantid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

-- Table: public.kl_birth_father_information

-- DROP TABLE IF EXISTS public.kl_birth_father_information;

CREATE TABLE IF NOT EXISTS public.kl_birth_father_information
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT kl_birth_father_information_pkey PRIMARY KEY (id),
    CONSTRAINT kl_birth_father_information_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.kl_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
);
-- Index: idx_kl_birth_father_information_birthdtlid

-- DROP INDEX IF EXISTS public.idx_kl_birth_father_information_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_kl_birth_father_information_birthdtlid
    ON public.kl_birth_father_information USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

-- Table: public.kl_birth_mother_information

-- DROP TABLE IF EXISTS public.kl_birth_mother_information;

CREATE TABLE IF NOT EXISTS public.kl_birth_mother_information
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    firstname_en character varying(200) COLLATE pg_catalog."default",
    firstname_ml character varying(200) COLLATE pg_catalog."default",
    ...
    lastmodifiedby character varying(64) COLLATE pg_catalog."default",
    birthdtlid character varying(64) COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT kl_birth_mother_information_pkey PRIMARY KEY (id),
    CONSTRAINT kl_birth_mother_information_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.kl_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    );

-- Index: idx_kl_birth_mother_information_birthdtlid

-- DROP INDEX IF EXISTS public.idx_kl_birth_mother_information_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_kl_birth_mother_information_birthdtlid
    ON public.kl_birth_mother_information USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;


-- Table: public.kl_birth_permanent_address

-- DROP TABLE IF EXISTS public.kl_birth_permanent_address;

CREATE TABLE IF NOT EXISTS public.kl_birth_permanent_address
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT kl_birth_permanent_address_pkey PRIMARY KEY (id),
    CONSTRAINT kl_birth_permanent_address_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.kl_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
);

-- Index: idx_kl_birth_permanent_address_info_birthdtlid

-- DROP INDEX IF EXISTS public.idx_kl_birth_permanent_address_info_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_kl_birth_permanent_address_info_birthdtlid
    ON public.kl_birth_permanent_address USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

-- Table: public.kl_birth_place

-- DROP TABLE IF EXISTS public.kl_birth_place;

CREATE TABLE IF NOT EXISTS public.kl_birth_place
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    birthdtlid character varying(64) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT kl_birth_place_pkey PRIMARY KEY (id),
    CONSTRAINT kl_birth_place_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.kl_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
);

-- Index: idx_kl_birth_place_birthdtlid

-- DROP INDEX IF EXISTS public.idx_kl_birth_place_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_kl_birth_place_birthdtlid
    ON public.kl_birth_place USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

-- Table: public.kl_birth_present_address

-- DROP TABLE IF EXISTS public.kl_birth_present_address;

CREATE TABLE IF NOT EXISTS public.kl_birth_present_address
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    resdnce_addr_type character varying(64) COLLATE pg_catalog."default",
    buildingno character varying(200) COLLATE pg_catalog."default",
    ...
    lastmodifiedtime bigint,
    birthdtlid character varying(64) COLLATE pg_catalog."default",
    CONSTRAINT kl_birth_present_address_pkey PRIMARY KEY (id),
    CONSTRAINT kl_birth_present_address_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.kl_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
);
-- Index: idx_kl_birth_present_address_birthdtlid

-- DROP INDEX IF EXISTS public.idx_kl_birth_present_address_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_kl_birth_present_address_birthdtlid
    ON public.kl_birth_present_address USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;

-- Table: public.kl_birth_statitical_information

-- DROP TABLE IF EXISTS public.kl_birth_statitical_information;

CREATE TABLE IF NOT EXISTS public.kl_birth_statitical_information
(
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT kl_birth_statitical_information_pkey PRIMARY KEY (id),
    CONSTRAINT kl_birth_statitical_information_fkey FOREIGN KEY (birthdtlid)
    REFERENCES public.kl_birth_details (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
);
-- Index: idx_kl_birth_statitical_information_birthdtlid

-- DROP INDEX IF EXISTS public.idx_kl_birth_statitical_information_birthdtlid;

CREATE INDEX IF NOT EXISTS idx_kl_birth_statitical_information_birthdtlid
    ON public.kl_birth_statitical_information USING btree
    (birthdtlid COLLATE pg_catalog."default" ASC NULLS LAST)
    TABLESPACE pg_default;