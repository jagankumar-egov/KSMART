-- Table: public.kl_birth_details_audit

-- DROP TABLE IF EXISTS public.kl_birth_details_audit;

CREATE TABLE IF NOT EXISTS public.kl_birth_details_audit
(
...
-- FUNCTION: public.process_kl_birth_details_audit()

-- DROP FUNCTION IF EXISTS public.process_kl_birth_details_audit();

CREATE OR REPLACE FUNCTION public.process_kl_birth_details_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO kl_birth_details_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO kl_birth_details_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER kl_birth_place_audit
BEFORE DELETE OR UPDATE ON public.kl_birth_place
FOR EACH ROW EXECUTE FUNCTION public.process_kl_birth_place_audit();

-- Table: public.kl_birth_father_information_audit

-- DROP TABLE IF EXISTS public.kl_birth_father_information_audit;

CREATE TABLE IF NOT EXISTS public.kl_birth_father_information_audit
(
    operation character(1) COLLATE pg_catalog."default" NOT NULL,
    stamp timestamp without time zone NOT NULL,
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- FUNCTION: public.process_kl_birth_father_information_audit()

-- DROP FUNCTION IF EXISTS public.process_kl_birth_father_information_audit();

CREATE OR REPLACE FUNCTION public.process_kl_birth_father_information_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO kl_birth_father_information_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO kl_birth_father_information_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: kl_birth_father_information_audit

-- DROP TRIGGER IF EXISTS kl_birth_father_information_audit ON public.kl_birth_father_information;

CREATE TRIGGER kl_birth_father_information_audit
BEFORE DELETE OR UPDATE ON public.kl_birth_father_information
FOR EACH ROW EXECUTE FUNCTION public.process_kl_birth_father_information_audit();

-- Table: public.kl_birth_mother_information_audit

-- DROP TABLE IF EXISTS public.kl_birth_mother_information_audit;

CREATE TABLE IF NOT EXISTS public.kl_birth_mother_information_audit
(
    operation character(1) COLLATE pg_catalog."default" NOT NULL,
    stamp timestamp without time zone NOT NULL,
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- FUNCTION: public.process_kl_birth_mother_information_audit()

-- DROP FUNCTION IF EXISTS public.process_kl_birth_mother_information_audit();

CREATE OR REPLACE FUNCTION public.process_kl_birth_mother_information_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO kl_birth_mother_information_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO kl_birth_mother_information_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: kl_birth_mother_information_audit

-- DROP TRIGGER IF EXISTS kl_birth_mother_information_audit ON public.kl_birth_mother_information;

CREATE TRIGGER kl_birth_mother_information_audit
BEFORE DELETE OR UPDATE ON public.kl_birth_mother_information
FOR EACH ROW EXECUTE FUNCTION public.process_kl_birth_mother_information_audit();


-- Table: public.kl_birth_permanent_address_audit

-- DROP TABLE IF EXISTS public.kl_birth_permanent_address_audit;

CREATE TABLE IF NOT EXISTS public.kl_birth_permanent_address_audit
(
    operation character(1) COLLATE pg_catalog."default" NOT NULL,
    stamp timestamp without time zone NOT NULL,
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- FUNCTION: public.process_kl_birth_permanent_address_audit()

-- DROP FUNCTION IF EXISTS public.process_kl_birth_permanent_address_audit();

CREATE OR REPLACE FUNCTION public.process_kl_birth_permanent_address_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO kl_birth_permanent_address_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO kl_birth_permanent_address_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: kl_birth_permanent_address_audit

-- DROP TRIGGER IF EXISTS kl_birth_permanent_address_audit ON public.kl_birth_permanent_address;

CREATE TRIGGER kl_birth_permanent_address_audit
BEFORE DELETE OR UPDATE ON public.kl_birth_permanent_address
FOR EACH ROW EXECUTE FUNCTION public.process_kl_birth_permanent_address_audit();

-- Table: public.kl_birth_place_audit

-- DROP TABLE IF EXISTS public.kl_birth_place_audit;

CREATE TABLE IF NOT EXISTS public.kl_birth_place_audit
(
    operation character(1) COLLATE pg_catalog."default" NOT NULL,
    stamp timestamp without time zone NOT NULL,
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- FUNCTION: public.process_kl_birth_place_audit()

-- DROP FUNCTION IF EXISTS public.process_kl_birth_place_audit();

CREATE OR REPLACE FUNCTION public.process_kl_birth_place_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO kl_birth_place_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO kl_birth_place_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: kl_birth_place_audit

-- DROP TRIGGER IF EXISTS kl_birth_place_audit ON public.kl_birth_place;
...
CREATE TABLE IF NOT EXISTS public.kl_birth_present_address_audit
(
    operation character(1) COLLATE pg_catalog."default" NOT NULL,
    stamp timestamp without time zone NOT NULL,
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- Trigger: kl_birth_present_address_audit

-- DROP TRIGGER IF EXISTS kl_birth_present_address_audit ON public.kl_birth_present_address;

CREATE TRIGGER kl_birth_present_address_audit
BEFORE DELETE OR UPDATE ON public.kl_birth_present_address
FOR EACH ROW EXECUTE FUNCTION public.process_kl_birth_present_address_audit();

-- Table: public.kl_birth_statitical_information_audit

-- DROP TABLE IF EXISTS public.kl_birth_statitical_information_audit;

CREATE TABLE IF NOT EXISTS public.kl_birth_statitical_information_audit
(
    operation character(1) COLLATE pg_catalog."default" NOT NULL,
    stamp timestamp without time zone NOT NULL,
    id character varying(64) COLLATE pg_catalog."default" NOT NULL,
...
-- FUNCTION: public.process_kl_birth_statitical_information_audit()

-- DROP FUNCTION IF EXISTS public.process_kl_birth_statitical_information_audit();

CREATE OR REPLACE FUNCTION public.process_kl_birth_statitical_information_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO kl_birth_statitical_information_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO kl_birth_statitical_information_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER kl_birth_statitical_information_audit
BEFORE DELETE OR UPDATE ON public.kl_birth_statitical_information
FOR EACH ROW EXECUTE FUNCTION public.process_kl_birth_statitical_information_audit();