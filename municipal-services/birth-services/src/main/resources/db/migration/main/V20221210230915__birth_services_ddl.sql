...
-- FUNCTION: public.process_eg_register_birth_details_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_details_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_details_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_details_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_details_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
CREATE TRIGGER eg_register_birth_details_audit BEFORE DELETE OR UPDATE
                         ON public.eg_register_birth_details
                         FOR EACH ROW
                         EXECUTE FUNCTION public.process_eg_register_birth_details_audit();

-- Table: public.eg_register_birth_father_information_audit

-- DROP TABLE IF EXISTS public.eg_register_birth_father_information_audit;
...
-- FUNCTION: public.process_eg_register_birth_father_information_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_father_information_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_father_information_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_father_information_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_father_information_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: eg_register_birth_father_information_audit

-- DROP TRIGGER IF EXISTS eg_register_birth_father_information_audit ON public.eg_register_birth_father_information;

CREATE TRIGGER eg_register_birth_father_information_audit  BEFORE DELETE OR UPDATE
                         ON public.eg_register_birth_father_information
                         FOR EACH ROW
                         EXECUTE FUNCTION public.process_eg_register_birth_father_information_audit();

-- Table: public.eg_register_birth_mother_information_audit

-- DROP TABLE IF EXISTS public.eg_register_birth_mother_information_audit;
...
-- FUNCTION: public.process_eg_register_birth_mother_information_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_mother_information_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_mother_information_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_mother_information_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_mother_information_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
$BODY$;
    -- Table: public.eg_register_birth_multiple_details_audit

-- DROP TABLE IF EXISTS public.eg_register_birth_multiple_details_audit;
...
-- FUNCTION: public.process_eg_register_birth_multiple_details_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_multiple_details_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_multiple_details_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_multiple_details_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_multiple_details_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: eg_register_birth_multiple_details_audit

-- DROP TRIGGER IF EXISTS eg_register_birth_multiple_details_audit ON public.eg_register_birth_multiple_details;

CREATE TRIGGER eg_register_birth_multiple_details_audit
    BEFORE DELETE OR UPDATE
                         ON public.eg_register_birth_multiple_details
                         FOR EACH ROW
                         EXECUTE FUNCTION public.process_eg_register_birth_multiple_details_audit();
-- Table: public.eg_register_birth_permanent_address_audit

-- DROP TABLE IF EXISTS public.eg_register_birth_permanent_address_audit;
...
-- FUNCTION: public.process_eg_register_birth_permanent_address_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_permanent_address_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_permanent_address_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_permanent_address_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_permanent_address_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: eg_register_birth_permanent_address_audit

-- DROP TRIGGER IF EXISTS eg_register_birth_permanent_address_audit ON public.eg_birth_permanent_address;

CREATE TRIGGER eg_register_birth_permanent_address_audit
    BEFORE DELETE OR UPDATE
                         ON public.eg_register_birth_permanent_address
                         FOR EACH ROW
                         EXECUTE FUNCTION public.process_eg_register_birth_permanent_address_audit();

-- Table: public.eg_register_birth_place_audit

-- DROP TABLE IF EXISTS public.eg_register_birth_place_audit;
...
-- FUNCTION: public.process_eg_register_birth_place_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_place_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_place_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_place_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_place_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: eg_register_birth_place_audit
...
-- DROP TABLE IF EXISTS public.eg_register_birth_present_address_audit;
...
(
   ...
   -- FUNCTION: public.process_eg_register_birth_present_address_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_present_address_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_present_address_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_present_address_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_present_address_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: eg_register_birth_present_address_audit

-- DROP TRIGGER IF EXISTS eg_register_birth_present_address_audit ON public.eg_register_birth_present_address;

CREATE TRIGGER eg_register_birth_present_address_audit
    BEFORE DELETE OR UPDATE
                         ON public.eg_register_birth_present_address
                         FOR EACH ROW
                         EXECUTE FUNCTION public.process_eg_register_birth_present_address_audit();

-- Table: public.eg_register_birth_statitical_information_audit

-- DROP TABLE IF EXISTS public.eg_register_birth_statitical_information_audit;
...
-- FUNCTION: public.process_eg_register_birth_statitical_information_audit()

-- DROP FUNCTION IF EXISTS public.process_eg_register_birth_statitical_information_audit();

CREATE OR REPLACE FUNCTION public.process_eg_register_birth_statitical_information_audit()
    RETURNS trigger
    LANGUAGE 'plpgsql'
    COST 100
    VOLATILE NOT LEAKPROOF
...
BEGIN
        IF (TG_OP = 'DELETE') THEN
            INSERT INTO eg_register_birth_statitical_information_audit SELECT 'D', now(), OLD.*;
RETURN OLD;
ELSIF (TG_OP = 'UPDATE') THEN
            INSERT INTO eg_register_birth_statitical_information_audit SELECT 'U', now(), OLD.*;
RETURN NEW;
END IF;
RETURN NULL;
END;
...
-- Trigger: eg_register_birth_statitical_information_audit

-- DROP TRIGGER IF EXISTS eg_register_birth_statitical_information_audit ON public.eg_register_birth_statitical_information;

CREATE TRIGGER eg_register_birth_statitical_information_audit
    BEFORE DELETE OR UPDATE
                         ON public.eg_register_birth_statitical_information
                         FOR EACH ROW
                         EXECUTE FUNCTION public.process_eg_register_birth_statitical_information_audit();
